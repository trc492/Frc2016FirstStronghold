...
import frclibj.TrcRobot.RunMode;

public class TrcDriveBase extends RobotDrive implements TrcTaskMgr.Task
{
    ...
    public void mecanumDrive_Cartesian(
            double x, double y, double rotation, double gyroAngle)
    {
        super.mecanumDrive_Cartesian(x, -y, rotation, gyroAngle);
    }   //mecanumDrive_Cartesian

    public void arcadeDrive(
            double moveValue, double rotateValue, boolean squaredInputs)
    {
