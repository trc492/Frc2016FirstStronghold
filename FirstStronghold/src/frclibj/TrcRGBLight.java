...
public class TrcRGBLight extends TrcPneumatic
{
    ...
    public ColorLightState getColorLightState()
    {
        ...
        if (debugEnabled)
        {
            ...
            dbgTrace.traceExit(
                    ...
                    colorLightState.notifyEvent.getName());
        }
    ...
    public void setColor(RGBColor color, double period, TrcEvent event)
    {
        ...
        if (debugEnabled)
        {
            dbgTrace.traceEnter(
                    ...
                    color.toString(), period, event.getName());
        }
            ...
            TrcEvent event)
    {
        ...
        if (debugEnabled)
        {
            dbgTrace.traceEnter(
                    funcName, TrcDbgTrace.TraceLevel.API,
                    "color=%s,OnPeriod=%f,OffPeriod=%f,event=%s",
                    color.toString(), onPeriod, offPeriod, event.getName());
        }
            ...
            TrcEvent event)
    {
        ...
        if (debugEnabled)
        {
            dbgTrace.traceEnter(
                    ...
                    numActions, Boolean.toString(repeat), event.getName());
        }
